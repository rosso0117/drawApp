//
//  BackGrounColorViewController.swift
//  arcPath
//
...
class BackGrounColorViewController: UIViewController {
    ...
    func setBGColor() {
        myAppDelegate.bgColor = self.view.backgroundColor
        myAppDelegate.myFirstTab.view.backgroundColor = self.view.backgroundColor
    }
